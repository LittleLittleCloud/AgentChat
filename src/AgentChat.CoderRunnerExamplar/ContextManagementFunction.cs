...
public partial class ContextManagementFunction
{
    ...
    [FunctionAttribution]
    public async Task<string> SaveContext(string task, string[] completedSteps, string currentStep, string[] existingFunctions,
                                          string[] existingVariables, string[] existingClass, string context)
    {
        var result = $@"
-Task-
{task}
