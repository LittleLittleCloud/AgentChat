...
namespace GroupChatExample.CodingTask
{
    public static class Constant
    {
        ...
        public static string GPT_35_MODEL_ID { get; set; } = "JulyChat";

        public static string GPT_4_MODEL_ID { get; set; } = "gpt-4";
        ...
        public static OpenAIClient GPT35 { get; set; } = new OpenAIClient(
            new Uri(GPT_35_ENDPOINT),
            new Azure.AzureKeyCredential(GPT_35_API_KEY));

        public static OpenAIClient GPT4 { get; set; } = new OpenAIClient(
