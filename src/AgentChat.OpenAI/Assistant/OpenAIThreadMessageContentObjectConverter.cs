...
namespace AgentChat.OpenAI
{
    public class OpenAIThreadMessageContentObjectConverter : JsonConverter<OpenAIThreadMessageContentObject>
    {
        public override bool CanConvert(Type typeToConvert)
        {
            ...
            return typeof(OpenAIThreadMessageContentObject).IsAssignableFrom(typeToConvert);
        }

        public override OpenAIThreadMessageContentObject? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
