...
namespace AgentChat.SourceGenerator
{
    ...
    public partial class FunctionCallGenerator : IIncrementalGenerator
    {
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            // step 2
            context.RegisterSourceOutput(partialClassSyntaxProvider,
                (ctx, source) =>
                {
                    var groups = source.GroupBy(item => item.fullClassName);
                    ...
                    var overallFunctionDefinition = source.SelectMany(x => x.functionContracts.Select(y => new { fullClassName = x.fullClassName, y = y }));
                    ...
                    var json = JsonSerializer.Serialize(overallFunctionDefinitionObject, new JsonSerializerOptions { WriteIndented = true });
