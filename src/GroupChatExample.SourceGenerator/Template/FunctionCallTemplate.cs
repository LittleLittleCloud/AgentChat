...
// </auto-generated>
// ------------------------------------------------------------------------------
namespace GroupChatExample.SourceGenerator.Template
{
    using System.Linq;
    using System.Text;
...
foreach (var parameter in functionContract.Parameters) {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(parameter.Name));
            this.Write(" = new\r\n\t\t\t\t\t    {\r\n\t\t\t\t\t\t    Type = @\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(parameter.JsonType));
            this.Write("\",\r\n");
if(parameter.JsonType == "array" && parameter.JsonItemType != null) {
            this.Write("                            Items = new\r\n\t\t\t\t\t\t\t{\r\n\t\t\t\t\t\t\t\tType = @\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(parameter.JsonItemType));
            this.Write("\",\r\n\t\t\t\t\t\t\t},\r\n");
}
            ...
            this.Write("\",\r\n");
if (parameter.IsOptional) {
            this.Write("\t\t\t\t\t\t    IsOptional = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(parameter.IsOptional.ToString().ToLower()));
            this.Write(",\r\n");
}
