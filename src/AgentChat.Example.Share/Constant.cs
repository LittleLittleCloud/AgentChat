...
namespace AgentChat.Example.Share
{
    public static class Constant
    {
        ...
        public static GPT? AzureGPT4 { get; set; } = AZURE_OPENAI_API_KEY != null ? GPT.CreateFromAzureOpenAI(GPT_4_MODEL_ID, AZURE_OPENAI_API_KEY, AZURE_OPENAI_ENDPOINT) : null;

        public static GPT? OpenAIGPT4 { get; set; } = OPENAI_API_KEY != null ? GPT.CreateFromOpenAI(OPENAI_API_KEY, GPT_4_MODEL_ID) : null;

        public static GPT? AzureGPT35 { get; set; } = AZURE_OPENAI_API_KEY != null ? GPT.CreateFromAzureOpenAI(GPT_35_MODEL_ID, AZURE_OPENAI_API_KEY, AZURE_OPENAI_ENDPOINT) : null;

        public static GPT? OpenAIGPT35 { get; set; } = OPENAI_API_KEY != null ? GPT.CreateFromOpenAI(OPENAI_API_KEY, GPT_35_MODEL_ID) : null;


        public static GPT GPT4 { get; set; } = AzureGPT4 ?? OpenAIGPT4 ?? throw new Exception(@"No OpenAI client is available. Please choose one of the folloiwng option
- Set `OPENAI_API_KEY`
- Set `AZURE_OPENAI_API_KEY and AZURE_OPENAI_ENDPOINT`
in your environment to provide access to OpenAI GPT model");

        public static GPT GPT35 { get; set; } = AzureGPT35 ?? OpenAIGPT35 ?? throw new Exception(@"No OpenAI client is available. Please choose one of the folloiwng option
- Set `OPENAI_API_KEY`
- Set `AZURE_OPENAI_API_KEY and AZURE_OPENAI_ENDPOINT`
in your environment to provide access to OpenAI GPT model");
    }
